"""
Fantasy analytics for Midwicket.
...
# "midwicket.api.fantasy.get_session" etc. without circular-import issues.
def get_session():
...
def get_executor():
    from midwicket.api.session import get_executor as _get_executor
    return _get_executor()


def get_registry():
    from midwicket.api.session import get_registry as _get_registry
