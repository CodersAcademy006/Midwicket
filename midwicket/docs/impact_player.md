# Impact Player Rule Support in Midwicket

Midwicket is architected with flexibility in mind, supporting evolving cricket rules such as the "Impact Player" rule introduced in IPL 2023. The system can adapt to new rules without requiring code changes.

## Overview

The Impact Player rule allows teams to substitute a player during a match, effectively creating a 12th player scenario. Midwicket's architecture inherently supports this and similar rule changes through its flexible schema design.
...
Midwicket supports new cricket rules through several key design principles:
...
```python
# Midwicket handles 12+ players seamlessly
...
Midwicket automatically handles impact player data from Cricsheet:
...
Midwicket's flexible architecture makes it easy to support future rule changes:
...
# Midwicket will ingest it automatically
```
...
Midwicket's data model for handling impact players:
...
3. **Update Regularly**: Keep Midwicket updated for the latest rule support
4. **Validate Data**: Verify impact player data is correctly ingested

## FAQ

**Q: Do I need to modify my code for impact player support?**  
A: No, Midwicket handles impact players automatically through existing APIs.

**Q: How does Midwicket identify impact players?**  
A: Midwicket uses data from Cricsheet which includes impact player flags.
...
**Q: Will Midwicket support future rule changes?**  
A: Yes, Midwicket's flexible architecture is designed to adapt to new rules.
...
For technical questions about impact player support, please open an issue on [GitHub](https://github.com/CodersAcademy006/Midwicket/issues).
