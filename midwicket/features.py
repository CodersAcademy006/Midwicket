"""
Midwicket Feature Store: Standardized Feature Calculations
...
class RollingFeature:
    ...
    def compute(self, session: MidwicketSession, player_id: Union[str, int]) -> Any:
        """
...
class MomentumIndicator:
    ...
    def calculate_recent_form(self, session: MidwicketSession, player_id: Union[str, int]) -> Dict[str, float]:
        """
...
class FatigueMetric:
    ...
    def calculate_workload(self, session: MidwicketSession, player_id: Union[str, int]) -> Dict[str, Any]:
        """
...
def get_rolling_strike_rate(session: MidwicketSession, player_id: Union[str, int], window: int = 10):
...
def get_recent_form(session: MidwicketSession, player_id: Union[str, int]):
    """Get recent form indicators."""
    indicator = MomentumIndicator()
    return indicator.calculate_recent_form(session, player_id)

def get_fatigue_level(session: MidwicketSession, player_id: Union[str, int]):
