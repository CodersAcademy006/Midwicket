...
class MidwicketClient:
    """Client for interacting with Midwicket API servers."""
    ...
    def __init__(
        ...
        """
        Initialize the Midwicket API client.

        Args:
            base_url: Base URL of the Midwicket API server
    ...
    def __enter__(self) -> "MidwicketClient":
        return self
...
def connect(
    ...
    """Create a Midwicket API client connection."""
    return MidwicketClient(base_url, api_key, timeout)
...
def quick_health_check(
    ...
    client = MidwicketClient(base_url, api_key, timeout)
    try:
