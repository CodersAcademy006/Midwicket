"""
PDF Report Generator for Midwicket
...
class PDFGenerator:
    ...
    def create_scouting_report(self, player_id: str, output_path: str) -> None:
        ...
        footer_text = f"Report generated on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} by Midwicket Analytics"
...
def create_scouting_report(session: MidwicketSession, player_id: str, output_path: str) -> None:
...
def create_match_report(session: MidwicketSession, match_id: str, output_path: str) -> None:
