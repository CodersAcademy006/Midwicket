...
class TestSchemaEvolution:
    def test_compatible_upgrade_returns_true(self):
        from midwicket.schema.evolution import validate_compatibility
        old = {"version": "1.0.0"}
        new = {"version": "1.1.0"}
    ...
    def test_parse_version_helper(self):
        from midwicket.schema.evolution import _parse_version
...
class TestDeprecationUtils:
    def test_deprecation_module_importable(self):
        import midwicket.utils.deprecation as dep
...
class TestLicenseUtils:
    def test_cricsheet_notice_defined(self):
        from midwicket.utils.license import CRICSHEET_NOTICE
    ...
    def test_print_license_notice_does_not_raise(self):
        from midwicket.utils.license import print_license_notice
...
class TestSchemaMigration:
    def test_module_importable(self):
        import midwicket.utils.schema_migration as sm
...
class TestSnapshotsModule:
    def test_module_importable(self):
        import midwicket.storage.snapshots as sn
...
class TestVideoSyncUtils:
    def test_get_video_timestamp_found(self):
        from midwicket.utils.video_sync import get_video_timestamp
