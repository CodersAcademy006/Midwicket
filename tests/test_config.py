...
def test_out_of_range_db_threads_falls_back_to_default(
    ...
    monkeypatch.setenv("MIDWICKET_DB_THREADS", bad_threads)
    cfg = _reload_config_module()
    assert cfg.DATABASE_THREADS == 4
